...
def process_inputs(input1, input2, input3):
    ...
    user_temp = input2
    user_key = input3
    return user_seed, user_temp, user_key

class MelodyGenerator:
    
    def __init__(self, model_path="C:/Users/reese/Documents/JuceTest/JuceTest/Source/model.h5"):
    ...
    def save_melody(self, melody, user_key, step_duration=0.25, format="midi", file_name="mel.midi"):
        ...
        full_file_path = "C:/Users/reese/Documents/" + file_name

        #write m21 stream to midi
        transposed_stream.write(format, full_file_path)
...
if __name__ == "__main__":
    ...
    #get inputs from main
    input1 = int(sys.argv[1])
    input2 = int(sys.argv[2])
    input3 = int(sys.argv[3])
    
    #define the seed, temp, key based on input
    user_seed,user_temp,user_key = process_inputs(input1,input2,input3)
    ...
    #generate melody and save the file
